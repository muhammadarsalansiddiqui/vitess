...
public class VitessMySQLDatabaseMetadata extends VitessDatabaseMetaData
    ...
    @SuppressWarnings("StringBufferReplaceableByString") public ResultSet getTables(String catalog,
        ...
        return new VitessResultSet(getConnection(), columnNames, columnTypes, data);
    }

    public ResultSet getSchemas() throws SQLException {
        String[] columnNames = {"TABLE_SCHEM", "TABLE_CATALOG"};
        Query.Type[] columnType = {Query.Type.CHAR, Query.Type.CHAR};
        return new VitessResultSet(getConnection(), columnNames, columnType, new String[][] {});
    }
    ...
    public ResultSet getCatalogs() throws SQLException {
        ...
        return new VitessResultSet(getConnection(), columnName, columntype, data);
    }
    ...
    public ResultSet getTableTypes() throws SQLException {
        ...
        String[][] data =
            new String[][] {{"LOCAL TEMPORARY"}, {"SYSTEM TABLES"}, {"SYSTEM VIEW"}, {"TABLE"},
                {"VIEW"}};
        return new VitessResultSet(getConnection(), columnNames, columnType, data);
    }
    ...
    @SuppressWarnings("StringBufferReplaceableByString") public ResultSet getPrimaryKeys(
        ...
        return new VitessResultSet(getConnection(), columnNames, columnType, sortedData);
    }
