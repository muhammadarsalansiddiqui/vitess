...
public class ConnectionProperties {
  ...
  private BooleanConnectionProperty twopcEnabled = new BooleanConnectionProperty(Constants.Property.TWOPC_ENABLED, false);
  private BooleanConnectionProperty excludeFieldMetadata = new BooleanConnectionProperty(Constants.Property.EXCLUDE_FIELD_METADATA, false);
  ...
  public boolean getExcludeFieldMetadata() {
    return excludeFieldMetadata.getValueAsBoolean();
  }

  public boolean getTwopcEnabled() {
    return twopcEnabled.getValueAsBoolean();
  }
