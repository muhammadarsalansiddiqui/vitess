...
public class VitessResultSetMetaData implements ResultSetMetaData {
    ...
    public int getScale(int column) throws SQLException {
        if (isDecimalType(getColumnType(column))) {
    ...
    public String getColumnClassName(int column) throws SQLException {
        FieldWithMetadata field = getField(column);
        return getClassNameForJavaType(field.getJavaType(), field.isUnsigned(), field.isBinary() || field.isBlob(), field.isOpaqueBinary(), connection.getYearIsDateType());
    }
    ...
    static String getClassNameForJavaType(int javaType, boolean isUnsigned, boolean isBinaryOrBlob, boolean isOpaqueBinary,
    ...
    private int clampedGetLength(FieldWithMetadata f) {
