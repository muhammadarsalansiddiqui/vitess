...
func TestCompareRows(t *testing.T) {
	table := []struct {
		...
		{
			fields: []*querypb.Field{{"a", sqltypes.Int32, "foo"}},
		...
		{
			fields: []*querypb.Field{
				{"a", sqltypes.Int32, "foo"},
				{"b", sqltypes.Int32, "foo"},
			},
			left: []sqltypes.Value{
		...
		{
			fields: []*querypb.Field{{"a", sqltypes.Uint64 ,"foo"}},
		...
		{
			fields: []*querypb.Field{{"a", sqltypes.Float64, "foo"}},
		...
		{
			fields: []*querypb.Field{{"a", sqltypes.Char, "foo"}},
